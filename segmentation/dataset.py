...
####
class __SCMC(__AbstractDataset):
    """Defines the SCMC dataset as originally introduced in:

    data prepared by ourselves
    ...
    def load_ann(self, path, with_type=True):
        ...
        if with_type:
            ...
            # merge classes for SCMC_data
            ann_type[ann_type==6] = 2
            ann_type[ann_type==7] = 3
            ann_type[ann_type==8] = 4
            ann_type[ann_type==9] = 4
            ann_type[ann_type==5] = 6
            ann_type[ann_type==10] = 5
            ann_type[ann_type==11] = 5
            ann_type[ann_type>6] = 7
