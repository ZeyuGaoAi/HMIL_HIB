...
class Config(object):
    ...
    def __init__(self):
        ...
        self.dataset_name = "scmc" # extracts dataset info from dataset.py
        self.log_dir = "logs/" # where checkpoints will be saved

        # paths to training and validation patches
        self.train_dir_list = [
            "./dataset/training_data/scmc/train/540x540_164x164/"
        ]
        self.valid_dir_list = [
            "./dataset/training_data/scmc/valid/540x540_164x164/"
        ]
